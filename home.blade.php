            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="/" class="site_title"><i class="fa fa-paw"></i> <span>Shopit</span></a>
                    </div>
                    ...
                    <br />
                    <?php
                        DvInclude($payload, 'sidebar.blade.php');
                    ?>
                </div>
            </div>
            <!-- top navigation -->
                ...
                <div class="nav_menu">
                    ...
                    <span class=" fa fa-angle-down"></span>
                                ...
                                <ul class="dropdown-menu dropdown-usermenu pull-right">
                                    <li>
                                        <a href="/service/shopit/view/index/"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
            ...
            <div class="right_col" role="main">
                <div class="row tile_count">
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-clock-o"></i> Processed Orders</span>
                        <div class="count">0</div>
                    </div>
                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Pending<small>orders waiting for dispatch</small></h2>
                        ...
                        <div class="x_content">
                            <table class="table table-striped">
                                ...
                                <tbody class="dv-where:order_status:0:get-all:shopit:orders">
                                    <tr>
